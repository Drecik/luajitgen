...
#ifdef _GC_DEBUG3
#include <stdio.h>
#define gc_debug3(...) printf(__VA_ARGS__); fflush(stdout);
#else
#define gc_debug3(...) ((void)0)
#endif

#ifdef _GC_DEBUG4
#include <stdio.h>
#define gc_debug4(...) printf(__VA_ARGS__); fflush(stdout);
#else
#define gc_debug4(...) ((void)0)
#endif

#ifdef _GC_DEBUG5
#include <stdio.h>
#define gc_debug5(...) printf(__VA_ARGS__); fflush(stdout);
#else
